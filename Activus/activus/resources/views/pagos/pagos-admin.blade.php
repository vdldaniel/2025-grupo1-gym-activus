...
<div class="container py-4">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-5 gap-3">
    ...
    <button class="btn btn-agregar py-2 px-4 d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#modalPago">
  ...
  <div class="card shadow-sm border-secondary rounded-2">
    <div class="card-body">
      ...
      <div class="input-group mb-3">
        <span class="input-group-text card-input bg-transparent border-secondary d-flex align-items-center justify-content-center" 
        ...
        <input id="buscador" type="text"
              class="form-control card-input border-secondary bg-dark text-light"
        ...
        <form id="formPago" autocomplete="off">
          ...
          <div class="row g-2 mb-3">
            ...
            <div class="col-6">
              ...
              <input type="text" id="idSocio" name="idSocio" class="form-control card-input" placeholder="Buscar por ID">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <textarea id="observacion" name="observacion" class="form-control card-input" rows="2" placeholder="Opcional: observaciones internas"></textarea>
          </div>

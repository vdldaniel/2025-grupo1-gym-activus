    ...
    <div class="card bg-card  shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-column gap-2">
                ...
                <div class="d-flex align-items-center gap-2"><i data-lucide="calendar" class="text-muted"></i> <span
                        class="small">Miembro desde: {{ $socio->usuario->Fecha_Alta }}</span>
                </div>
            </div>
        </div>
    </div>
        ...
        @if($idUsuario == $usuario->ID_Usuario)
            <div class="card bg-card shadow-sm">
                ...
                <div class="card-body d-flex flex-column gap-2">
                    ...
                    <button type="button"
                        class="btn 
                                                    @if(!$certificadoEsteAnio) btn-danger btn-sm custom-btn @else btn btn-outline-primary-element btn-sm custom-btn @endif"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content bg-card ">
                ...
                <div class="modal-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach($certificados as $certificado)
                                    <tr>
                                        <td>
                                            <a href="{{ asset('storage/app/public/' . $certificado->Imagen_Certificado) }}" target="_blank"
                                                class="text-primary me-2">Ver</a>
                    ...
                    <form action="{{ route('usuarios.subirCertificado', $usuario->ID_Usuario) }}" method="POST"
                        ...
                        <button type="submit" class="btn btn-agregar">Subir</button>
                    </form>
                    ...
                    <form method="POST" action="{{ route('usuarios.cambiarFoto', $usuario->ID_Usuario) }}"
                        ...
                        <div class="mb-3 text-center">
                            ...
                            <div id="preview" class="mt-3">
                                @if ($usuario->Foto_Perfil)
                                    <img src="{{ asset('storage/app/public/' . $usuario->Foto_Perfil) }}"

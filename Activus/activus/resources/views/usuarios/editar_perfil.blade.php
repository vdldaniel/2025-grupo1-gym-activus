    ...
    <div class="container py-4">
        <div class="mb-5">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h1 class="fw-bold mb-0">{{ $usuario->Nombre }} {{ $usuario->Apellido }} - Editar Perfil</h1>
                    <small class="text-secondary small"></small>
                </div>
            </div>
        </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-8">
                            <div class="card bg-card  shadow-sm">
                                ...
                                <div class="card-body">
                                    <form id="editPerfil"
                                        action="{{ route('usuarios.enviarEdicion', $usuario->ID_Usuario) }}" method="POST">
                                        @csrf
                                        ...
                                        @if($rolId === 4)
                                            <div class="mt-3">
                                                ...
                                                <input type="date" id="scheduleDate" name="Fecha_Nacimiento"
                                                    class="form-control card-input"
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" id="phone" name="Telefono" class="form-control card-input"

        ...
        <div class="card-body">
            <div class="d-flex align-items-center gap-3 mb-3">
                ...
                <div>
                    ...
                    <small class="mb-1 small">Rol: Profesor</small>
                </div>
            </div>
            <div class="d-flex flex-column gap-2">
                ...
                <div class="d-flex align-items-center gap-2"><i data-lucide="calendar" class="text-muted"></i> <span
                        class="small">Miembro desde: {{ $usuario->Fecha_Alta }}</span>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-content bg-card ">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{ route('usuarios.cambiarFoto', $usuario->ID_Usuario) }}"
                            ...
                            <div class="text-end">
                                <button type="submit" class="btn btn-agregar">Guardar Foto</button>
                            </div>
                        </form>

    ...
    <div class="tab-pane fade" id="panel-ingresos" role="tabpanel">
        ...
        <div class="card shadow-sm border-secondary rounded-2">
            <div class="card-body">
                ...
                <div class="row g-2 mt-2">
                    <div class="col-sm-4">
                        <input type="text" id="buscarIngreso" class="form-control card-input"
                            placeholder="Buscar por nombre, DNI o ID...">
                    </div>

                    <div class="col-sm-3">
                        <input type="date" id="fechaDesde" class="form-control card-input">
                    </div>

                    <div class="col-sm-3">
                        <input type="date" id="fechaHasta" class="form-control card-input">
                    </div>

                    <div class="col-sm-2">
                        <button class="btn btn-secondary w-100" id="filtrarIngresos">Filtrar</button>
                    </div>
                </div>
